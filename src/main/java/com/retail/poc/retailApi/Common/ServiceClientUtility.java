package com.retail.poc.retailApi.Common;

import com.retail.poc.retailApi.Exception.NonRetryableHttpStatusCodeException;
...
public class ServiceClientUtility {
    ...
    public static RuntimeException requestProcessingException(Logger log, String message) {
